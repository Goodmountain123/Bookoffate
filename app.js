...
const QUESTIONS = [
  ...
  // 갈등 충돌 ↔ 회피
  { text: '누군가가 술집에서 당신을 모욕했다.', choices: [
    '그 자리에서 손이 먼저 나간다',
    '한 마디 받아치고 분위기를 잡는다',
    '못 들은 척 흘려보낸다',
    '자리를 떠나고, 다시는 그곳에 가지 않는다',
  ]},
  ...
  // 따뜻함 ↔ 차가움
  { text: '낯선 사람이 비에 젖은 채 길가에 쓰러져 있다.', choices: [
    '망토를 벗어 덮어주고 안전한 곳으로 옮긴다',
    '의식이 있는지 확인하고 도와준다',
    '근처에 알리고 길을 간다',
    '위험할지도 모른다. 멀리 돌아간다',
  ]},
  ...
  // 현실적 ↔ 이상적
  { text: '누군가 "세상을 더 나은 곳으로 만들자"고 말한다. 당신의 속마음은?', choices: [
    '좋은 말이지만, 일단 오늘 먹을 빵부터',
    '그러려면 구체적으로 무엇부터 해야 할까?',
    '그 생각만으로도 마음이 움직인다',
    '그것이야말로 내가 살아가는 이유다',
  ]},
  ...
  // 호기심 ↔ 안정
  { text: '북쪽에 한 번도 알려지지 않은 땅이 있다는 소문을 들었다.', choices: [
    '당장 짐을 싸서 출발한다',
    '정보를 모은 뒤 떠난다',
    '누군가 다녀온 뒤 이야기를 들어본다',
    '지금 자리가 좋다. 굳이 갈 이유가 없다',
  ]},
  ...
  // 희망 ↔ 체념
  { text: '"세상은 결국 변하지 않는다"고 누군가 말한다.', choices: [
    '그래도 나는 변할 수 있다고 믿는다',
    '큰 변화는 어려워도, 작은 변화는 가능하다',
    '그 말이 맞을지도 모른다. 다만 받아들일 뿐',
    '그래서 무엇을 하든 결국 같다',
  ]},
];
