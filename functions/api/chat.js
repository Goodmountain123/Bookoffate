...
# 분석 방식 (★★★★★ 가장 중요)
- 답변이 드러내는 **성격 차원**을 추출하라.
- 답변에서 사용자의 성격을 유추하라.
- 성격은 가장 본질적이고 표면적이며 보편적인 것을 찾아라.
...
# 진부함 차단 (★★★★★)
- 두 번 같은 캐릭터를 만들면 실패다.
- 표면 성격(외향/내향, 감정/논리 등)으로 캐릭터를 만든다.
...
# 해설 작성 방식 (★★★★★ 가장 중요)
- 어조는 '당신은..."으로 하는 평서문
- 반드시 가장 먼저 캐릭터의 배경과 여정의 계기를 구체적·서사적으로 적고, 그 아래로는 취향, 선호, 태도 등의 표면적인 요소들을 적을 것.
...
- 해설이 다른 세계의 자신처럼 느껴지도록 성격 분석을 공감가게 반영
- 8000자 제한.
