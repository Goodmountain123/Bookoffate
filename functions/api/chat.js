...
const MODEL = 'gpt-4o-mini';   // 현재 프론티어급. 비용 절감용으로 'gpt-4o-mini' 가능.
...
const RACE_POOL = [
  ...
  '오크', '하프오크', '고블린',
  // 야수 인간형
  '늑대인간', '여우인간', '호랑이인간', '리저드맨', '사티로스', '켄타우로스', '미노타우로스',
  // 신성·이종 혈통
  '드래곤본', '티플링', '아아시마르', '마족', '천족',
  // 영적·원소
  '정령', '페이리', '바람의 아이', '불의 아이',
  // 수중·기타
  '인어', '뱀인간',
  ...
  '변신족', '뱀파이어', '리치(언데드)',
  // 인공·SF
  '안드로이드', '사이보그', '바이오 변종', '복제인간', '합성생명체', '나노 생명체',
  // 외계
  '회색 외계인', '파충류 외계인', '곤충형 외계인', '결정체 생명체',
  // 기타
  '골렘', '구울', '하피',
];
