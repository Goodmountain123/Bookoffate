...
답변에서 나온 결과를 그대로 캐릭터의 이야기에 적용하지 말고, 답변에 녹아있는 성향을 재해석해 완전히 캐릭터를 재구축한다.답변은 캐릭터의 성향이지, 캐릭터의 이야기가 아니다.
...
# 해설 작성 방식 (★★★★★ 가장 중요)
- 반드시 가장 먼저 캐릭터의 배경과 여정의 계기를 구체적으로, 서사적으로 적을 것. 계시나 예언 느낌으로 인물의 여정을 그릴것
