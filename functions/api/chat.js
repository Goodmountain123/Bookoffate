...
const MODEL = 'gpt-4.1-mini';   // 현재 프론티어급. 비용 절감용으로 'gpt-4o-mini' 가능.
...
const CLASS_POOL = [
  ...
  '악마 사냥꾼', '뱀파이어 사냥꾼',
  // 판타지 잠입
  '도적', '닌자', '거리의 사기꾼', '암살자', '암호 해독가', '함정 해제자',
  // 판타지 직업
  '용병', '현상금 사냥꾼', '밀렵꾼', '항해사', '소금 상인',
  '연금술 상인', '주술 거래상', '떠돌이', '길드 경비원', '마족 장교', '던전 설계자', '신전 수호자', '전령', '무기상', '고고학자',
  // 판타지 신성
  '사제', '수도사', '순례자', '치유사',
  // SF 전투
  '로봇 조종사', '폭파전문가', '우주 용병', '우주함대 장교',
  // SF 기술
  '해커', '사이오닉',
  // SF 사회·정보
  '외계 종족학자', '항법사', '우주 해적',
...
- 반드시 전투능력이 있는 클래스로 설정. 외교관, 정보상 등은 강력한 이유 없으면 회피. 

# 종족 규칙 (★ 다양성 매우 중요)
- 클래스와 어울리는 종족 1개.
- **인간·하프엘프는 너무 자주 나오는 디폴트라 강한 이유 없이 선택 금지.**
  · 인간을 고를 거라면 종족 특성(예: 북방인, 사막인, 도시인)을 함께 명시
  · 하프엘프도 마찬가지로 변형(예: 황혼의 하프엘프)으로 차별화
- 같은 클래스라도 종족을 매번 다르게.
...
[이번 호출의 영감 종족 후보]
다음은 이번 호출의 종족 영감입니다. 클래스와 어울리는 것을 고르거나, 비슷한 결의 다른 종족으로 응용해도 좋습니다. **인간과 하프엘프는 너무 자주 나오는 디폴트이니 강한 이유 없이 선택하지 마세요.**
