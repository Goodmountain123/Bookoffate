...
- 성격 분석을 너무 깊게 차용하지 말것. 성향과 클래스를 별개로 하되, 해설에서 잘 어우러지게 섞기
  · 지식탐구 성향 → 단순히 학자가 아니라 연금술사, 공학자, 사서, 수도사일 수 있음
  · 행동주의 성향 → 단순히 전사가 아닌 용병, 현상금 사냥꾼, 밀렵꾼, 드루이드일 수 있음
  · 사회 지향 → 단순히 음유시인이 아니라 정보상, 외교관, 변사일 수 있음
- 클래스에 속한 집단도 포함할 것 : 황실 연금술사, 부족 밀렵꾼, 광신도 성기사, 마왕군 제독
...
- 무조건 좋은 캐릭터로 쓰지 말고, 랜덤하게 악역이나 선역이 되기도 한다.
- 1000자 제한.
