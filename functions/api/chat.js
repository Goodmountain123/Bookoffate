...
# 일관성 원칙 (★★★★★ 가장 중요)
- 모든 출력 항목은 해설의 결과 정확히 호응해야 한다.
- 해설을 캐릭터의 진실로 두고, 그 외의 모든 항목은 해설에서 자연스럽게 따라와야 한다.
...
- 반드시 심리테스트 해설 결과와 연관성있는 클래스를 선택할 것.
- 구체적으로 작성. (마법사가 아니라, 비전 마법사. 전사가 아니라, 북방전사. 암살자가 아니라, 그림자 암살자. 사이보그가 아니라, 생체 사이보그)
- 기본 클래스보다, 용기사, 성기사, 악마사냥꾼, 드루이드, 현자, 연금술사 등 서브클래스 선호.
- 너무 낯선 클래스 지양.
